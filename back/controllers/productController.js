        ...
        productForm.parse(req, async (err, fields, files) => {
            try {
                ...
                for (const key in fields) {
                  ...
                  const { productId, producCategory, productManufacturer, productName, productVolume, productComposition, productPrice, oldCloudinaryPublicId, oldImagePath } = fields;
