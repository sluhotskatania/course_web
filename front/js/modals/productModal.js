...
const productModalContent = `<form name="productForm" enctype="multipart/form-data">
    ...
    <table class="form-table">
        ...
        <tr>
            <td class="form-label"><label for="productManufacturer">Manufacturer:</label> </td>
            <td class="form-input"><input type="text" name="productManufacturer" id="productManufacturer" class="form-control" required></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="form-input"><input type="number" name="productVolume" id="productVolume" class="form-control" min="5" max="2000" required></td>
        </tr>
                   <td class="form-label"><label for="productComposition">Composition:</label> </td>
            <td class="form-input"><input type="text" name="productComposition" id="productComposition" class="form-control" required></td>
        </tr>
        <tr>
            <td></td>
