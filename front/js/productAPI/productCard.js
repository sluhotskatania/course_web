...
export const productCardRender = (product) => {
    ...
    const commonProductCardPart =  ` <div class="product-card">
    <div class="product-front">
       <div><img src="${product.image}" class="product-img"></div>
        <div class="product-name">${product.name}</div>
        <div class="product-price">${product.price} &#x20b4</div>
    </div>
    <div class="product-back">
        <div class="product-data">
            <div class="product-category"><div class="product-category-text">${category.name}</div></div>
            <div class="product-text"><span class="product-manufacturer">${product.manufacturer}</span></div>
            <div class="product-name">${product.name}</div>
            <div class="product-text"><span class="product-volume">${product.volume}</span> ml</div>
            <div class="product-text"><span class="product-composition">${product.composition}</span></div>
        </div>`;
